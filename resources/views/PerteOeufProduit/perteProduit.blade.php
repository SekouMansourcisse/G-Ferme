            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Liste des pertes de produit</h4>
                        <h6>Gerer vos Declaration de pertes</h6>
                    </div>
                    @can('create Perte Produit')
                        <div class="page-btn">
                            <a href="{{ url('perte-produit-o-eufs/create') }}" class="btn btn-added"><img
                                ...
                                <ul>
                                    <li>
                                        <a data-bs-toggle="tooltip" data-bs-placement="top"
                                            href="{{ url('perteProduit/export-pdf') }}" title="pdf"><img
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center">Aucune perte enregistrée</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="editPerteForm" method="POST">
                    ...
                    <input type="hidden" name="type_perte" id="type_perte" value="Produit">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editPerteForm').submit(function(event) {
                ...
                $.ajax({
                    url: '/pertes-produit_update/' + perteId, // The route for the update action
        ...
        $('.delete-item-btn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/deletepertes-produit/' + perteId,
                        type: 'DELETE',
                        headers: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                Swal.fire('Supprimé!', 'La perte de produit a été supprimée.',
                                        'success')
        ...
        $('.edit-item-btn').click(function() {
            ...
            $.ajax({
                url: '/pertes-produit/' + perteId + '/edit',
                type: 'GET',
                success: function(response) {
                    ...
                    response.produits.forEach(function(produit) {
                        ...
                        <input type="number" class="form-control" name="qte_perdu[${produit.id}]" value="${produit.qte}">
                    </div>`
                        );
                    });
