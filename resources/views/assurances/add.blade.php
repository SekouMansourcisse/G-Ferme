            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Enregistrer une Assurance</h4>
                        <h6>Formulaire d'ajout de nouvelles Assurances</h6>
                    </div>
                </div>

                <div class="card">
                    <div class="card-body">
                        <form method="POST" id="add-form" action="{{ route('assurances.store') }}">
                            @csrf
                            <div class="row">
                                ...
                                <!-- Champ pour la compagnie d'assurance -->
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="compagnie">Compagnie d'Assurance <span
                                                class="text-danger">*</span></label>
                                ...
                                <!-- Champ pour la date d'activation -->
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="date_activation">Date d'Activation <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="date_expiration">Date d'Expiration <span
                                                class="text-danger">*</span></label>
