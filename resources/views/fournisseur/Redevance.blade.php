...
<body>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="{{url('showRemboursementF')}}" class="btn btn-added">
                            <img src="{{asset('assets/img/icons/plus.svg')}}" alt="img"> Ajouter un remboursement
                        </a>
                    </div>
                    @endcan
                    ...
                    <div class="card-body">
                        <div class="table-top">
                            ...
                            <div class="wordset">
                                <ul>
                                    <li>
                                        <a data-bs-toggle="tooltip" data-bs-placement="top" href="{{ url('remboursementF/export-pdf')}}" title="pdf"><img
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @if($remboursement->fournisseur!=null)
                                    <tr>
                                        <td>{{ $remboursement->date_r }}</td>
                                        <td>{{ $remboursement->Dette }}</td>
                                        <td>{{ $remboursement->montant_paye }}</td>
                                        <td>{{ $remboursement->NomPrenomFournisseur }}</td>
                                        @can('edit remboursement')
                                        <td>
                                            <a class="me-3 info-item-btn" href="javascript:void(0);" data-id="{{$remboursement->id}}">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><strong>Nom du Fournisseur:</strong> <span id="clientNom"></span></p>
                    ...
                    <p><strong>Fournisseur:</strong> <span id="fournisseurNom"></span></p>
    ...
    <div class="modal fade" id="editRemboursementModal" tabindex="-1" role="dialog" aria-labelledby="editRemboursementModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="editRemboursementForm" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="edit_date_reglement" name="date_r" readonly required>
                        </div>

                        <div class="form-group">
                            <label for="edit_fournisseur_id">Nom & Prénoms fournisseur <span class="text-danger">*</span></label>
                            <select class="form-control" id="edit_fournisseur_id" name="fournisseur" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="edit_montant" name="montant_paye" readonly required>
                        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#clientNom').text(response.remboursement.NomPrenomFournisseur);
                        ...
                        $('#fournisseurNom').text(response.remboursement.NomPrenomFournisseur);
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $('#edit_fournisseur_id').val(remboursement.fournisseur);
                ...
                operation=response.remboursement.operation_r;
                    operationsTable.append(
                        '<tr>' +
                            ...
                            '<td><input type="number" name="montant_paye" class="form-control" value="' + remboursement.montant_paye + '" readonly></td>' +
                        '</tr>'
                    );
                ...
                Swal.fire({
                    title: 'Erreur',
                    text: response.message || 'Une erreur est survenue lors de la récupération des données',
                    icon: 'error'
                });
            }
        },
