                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6 text-right">
                                <p><strong>Statut :</strong> {{ $etatRemboursement == true ? 'Non payé' : 'Payé' }}</p>
                        ...
                        <div class="row mt-4 justify-content-end">
                            <div class="col-md-4">
                                <p><strong>Montant à Rembourser :</strong> {{ $TotalR }} X0F</p>
                                <h4 class="text-right" style="background-color: #b38526; padding: 10px; color: white;">
                                    Total à payé: {{ $TotalR }} X0F</h4>
                            </div>
                        </div>
                        ...
                        @if (!$etatRemboursement)
                        <div class="invoice-signature" id="signer">
                            <div class="row">
                                <div class="col-md-6">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('Rembourser') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="TotalVente">Montant Total à Rembourser</label>
                                <input type="text" class="form-control" id="TotalVente"
                                    value="{{ $TotalR }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="Montant_paye" name="montant_paye" value="{{ $TotalR}}"
                                    required>
                            </div>
                            <div class="col-md-6">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('exportPdf').addEventListener('click', function () {
            ...
            html2canvas(element, {
                ...
                // Enregistrer le PDF
                pdf.save('Bon_RemboursementCmdN°#' + {{ $commande->id }} + '.pdf');
