            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <p><strong>Date de facture :</strong> {{ \Carbon\Carbon::parse($commande->date)->format('d/m/Y') }}</p>
                                <p><strong>Numéro de commande :</strong> #{{ $commande->id }}</p>
                            </div>
                            <div class="col-md-6 text-right">
                                <p><strong>Statut :</strong> {{ $commande->etat == 1 ? 'Non payé' : 'Payé' }}</p>
                                <p><strong>Date d'échéance :</strong> {{ \Carbon\Carbon::parse($commande->date_echeance)->format('d/m/Y') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4 justify-content-end">
                            <div class="col-md-4">
                                ...
                                <h4 class="text-right" style="background-color: #b38526; padding: 10px; color: white;">Total : {{ $commande->Net_a_payer }} X0F</h4>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 text-left">
                                ...
                                <a href="{{ url('commandes') }}" class="btn btn-secondary float-left mb-1" id="back"><i class="fa fa-arrow-circle-left" ></i> Retour </a>
                            </div>
                            <div class="col-md-6 text-right">
                                <a rel="noopener"  class="btn btn-secondary float-right mr-2" id="print"><i class="fas fa-print"></i>
                                    Impression</a>
                                    <button id="exportPdf" class="btn btn-primary float-right" style="margin-right: 5px;">
