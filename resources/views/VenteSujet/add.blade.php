...
<body>
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Interface de vente de sujet</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('vente-sujets.store') }}">
                            @csrf
                            <div class="row">
                             ...
                             @endphp
                                 @foreach($poulaillers as $index => $poulaillerEntry)
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="{{ count($poulaillers) }}">{{ $bande->nom_bande }} ({{ $bande->cheptel_actuel }} Sujet)</td>
                                        @endif
                                        <td>{{ $poulailler_n }}</td>
                                        <td>{{ $cheptel }}</td>
    ...
    <script src="{{ asset('js/backend/vente-sujet.js')}}"></script>
