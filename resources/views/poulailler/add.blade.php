            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Ajout de poulailler</h4>
                        <h6>Creer un nouveau poulailler</h6>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contenance_normale" id="contenance_normale" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Succès',
                    text: 'Le poulailler a été ajouté avec succès.',
            ...
            error: function(error) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Erreur',
                    text: 'Une erreur est survenue lors de l\'ajout du poulailler.',
                    confirmButtonColor: '#d33', // Couleur du bouton "OK"
                    confirmButtonText: 'OK', // Texte du bouton "OK"
                    customClass: {
                        confirmButton: 'btn btn-danger' // Classe CSS personnalisée pour le bouton "OK"
