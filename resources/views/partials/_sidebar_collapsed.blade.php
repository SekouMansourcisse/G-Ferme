            ...
            <aside id="aside" class="ui-aside">
                <ul class="tab nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link {{ Request::is('home') ? 'active' : '' }}" href="#home" id="home-tab" data-bs-toggle="tab"
                            data-bs-target="#home" role="tab" aria-selected="true">
                            <img src="{{ URL::asset('/build/img/icons/menu-icon.svg')}}" alt="">
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link {{ Request::is('listproduit','produit' ,'ravitaillement','add_viewravi', 'perte-produit-o-eufs*','perte-eufs*') ? 'active' : '' }}" href="#messages" id="messages-tab" data-bs-toggle="tab"
                            data-bs-target="#product" role="tab" aria-selected="false">
                            <img src="{{ URL::asset('/build/img/icons/product.svg')}}" alt="">
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link {{ Request::is('vente-oeufs*','vente-sujets*', 'vente-autres*') ? 'active' : '' }}" href="#profile" id="profile-tab" data-bs-toggle="tab"
