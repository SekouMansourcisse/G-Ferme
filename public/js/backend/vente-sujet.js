    ...
    $('#ajoutercategoriesBtn').click(function() {
        $('.categorie-checkbox:checked').each(function() {
            ...
            var row = '<tr>' +
                '<td>' + bande + '</td>' +
                '<td>' + cheptel + '</td>' +
                '<td><input type="number" class="form-control qte_vente" name="qte_vente[' + bandeId + ']" required></td>' +
                '<td><input type="number" class="form-control prix_unitaire" name="prixUnitaire[' + bandeId + ']" required></td>' +
                '<td><input type="number" class="form-control montant_total" name="Montant_total[' + bandeId + ']" required readonly></td>' +
